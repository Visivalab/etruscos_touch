...
// Hace la transición a la segunda fase del layout
  ...
  buildDivinity(){
      ...
      this.greekName.textContent = getLocalizedValue(db[this.divinity].greek_name)
      this.romanName.textContent = getLocalizedValue(db[this.divinity].roman_name)
      this.description.textContent = getLocalizedValue(db[this.divinity].description)
      this.longDescription.textContent = getLocalizedValue(db[this.divinity].long_description)
